...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'MO5_Project_4db2e0efe7c35a8c9900_20241202071826_archive.zip';
        const ARCHIVE_SIZE       = '137019033';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '4db2e0e-02071826';
        const SECONDARY_PACKAGE_HASH = '8a54d76-02071826';
